<div class="advertisers index">
	...
	<tr>
		...
		<td>
			<?php echo $this->Html->link($advertiser['User']['id'], array('controller' => 'users', 'action' => 'view', $advertiser['User']['id'])); ?>
		</td>
		<td><?php echo h($advertiser['Advertiser']['company_name']); ?>&nbsp;</td>
		<td><?php echo h($advertiser['Advertiser']['address1']); ?>&nbsp;</td>
		<td><?php echo h($advertiser['Advertiser']['address2']); ?>&nbsp;</td>
		...
		<td><?php echo h($advertiser['Advertiser']['contact2']); ?>&nbsp;</td>
