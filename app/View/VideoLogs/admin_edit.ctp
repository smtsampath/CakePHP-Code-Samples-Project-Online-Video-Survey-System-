...
<?php echo $this->Form->create('VideoLog');?>
	<fieldset>
		<legend><?php echo __('Admin Edit Video Log'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('VideoLog.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('VideoLog.id'))); ?></li>
