<div class="videoLogs index">
	...
	<tr>
		<td><?php echo h($videoLog['VideoLog']['id']); ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($videoLog['User']['id'], array('controller' => 'users', 'action' => 'view', $videoLog['User']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($videoLog['Video']['title'], array('controller' => 'videos', 'action' => 'view', $videoLog['Video']['id'])); ?>
		</td>
		<td><?php echo h($videoLog['VideoLog']['created']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $videoLog['VideoLog']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $videoLog['VideoLog']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $videoLog['VideoLog']['id']), null, __('Are you sure you want to delete # %s?', $videoLog['VideoLog']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
