<div class="videoFeedbackOptions index">
	...
	<tr>
		...
		<td>
			<?php echo $this->Html->link($videoFeedbackOption['VideoFeedback']['question'], array('controller' => 'video_feedbacks', 'action' => 'view', $videoFeedbackOption['VideoFeedback']['id'])); ?>
		</td>
		<td><?php echo h($videoFeedbackOption['VideoFeedbackOption']['option']); ?>&nbsp;</td>
		<td><?php echo h($videoFeedbackOption['VideoFeedbackOption']['valid']? "Yes" : "No"); ?>&nbsp;</td>
		<td class="actions">
