	...
	<?php
		...
		<tr>
			...
			<td class="actions">
				...
				<?php echo $this->Html->link(__('Edit'), array('controller' => 'video_feedback_options', 'action' => 'edit', $videoFeedbackOption['id'], $videoFeedback['VideoFeedback']['id'])); ?>
...
<?php endif; ?>
	...
	<div class="actions">
		<ul>
			<li><?php echo $this->Html->link(__('New Video Feedback Option'), array('controller' => 'video_feedback_options', 'action' => 'add', $videoFeedback['VideoFeedback']['id']));?> </li>
		</ul>
	</div>
</div>
