<div class="videoFeedbacks index">
	<h2><?php echo __('Video Feedbacks');?></h2>
	...
	<tr>
		<td><?php echo h($videoFeedback['VideoFeedback']['id']); ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($videoFeedback['Video']['title'], array('controller' => 'videos', 'action' => 'view', $videoFeedback['Video']['id'])); ?>
		</td>
		<td><?php echo h($videoFeedback['VideoFeedback']['question']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $videoFeedback['VideoFeedback']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $videoFeedback['VideoFeedback']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $videoFeedback['VideoFeedback']['id']), null, __('Are you sure you want to delete # %s?', $videoFeedback['VideoFeedback']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
