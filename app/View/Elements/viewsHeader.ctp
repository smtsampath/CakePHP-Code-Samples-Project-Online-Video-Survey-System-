	<div id="branding">
    	...
    	<div class="login">
    	<?php if ($logged_in): ?> 
        <p style="padding-top:45px;"><span>Welcome back <strong><?php echo $this->Session->read('Auth.User.fullname'); ?></strong></span>&nbsp; |&nbsp; <?php echo $this->Html->link(__('Logout'), '/logout/'); ?></p>
        <?php else: ?> 
        ...
        <?php echo $this->Form->create('User', array('url' => array('controller' => 'users', 'action' => 'login'))); ?>
            <ul>
                ...
                <li>
                    ...
                    <!--<input type="text" value="Email Address" onmouseout="hoverOff(this);" onmouseover="hoverOn(this);" onclick="clickclear(this, 'Email Address')" onblur="clickrecall(this,'Email Address')" class="hoverOff" name="email" />-->
                </li>
                <li>
	...
	<ul id="navigation">
		<?php if ($logged_in): ?> 
	        ...
	        <li><a href="/register" class="join_us">Join Us</a></li>
	        <li><a href="/contact" class="contact">Contact Us</a></li>
	        <li><a href="/advertisers/home" class="account">Account</a></li>
	        <?php endif; ?>
        <?php else: ?> 
	        <li class="border_none"><a href="/" class="home">Home</a></li>
	        <li><a href="/what-is-eloeel" class="about">What is Flipit</a></li>
