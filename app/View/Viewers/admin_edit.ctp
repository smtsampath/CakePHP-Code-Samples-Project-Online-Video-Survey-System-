...
<?php echo $this->Form->create('Viewer');?>
	<fieldset>
		<legend><?php echo __('Admin Edit Viewer'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Viewer.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Viewer.id'))); ?></li>
