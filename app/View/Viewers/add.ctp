...
<h2><?php echo __('Add Profile Information'); ?>&nbsp;</h2>
<table align="center" style="width:auto; padding:10px; margin-left:175px; float:left;border:0px;background-color:#151515;border-radius:0px ">
    ...
    <tr>
        <td style="text-align:left;"><?php echo __('NIC Number'); ?><b style="color:red;">&nbsp; * </b></td>
        <td style="text-align:left;width:50px">:</td>
    ...
    <tr>
        <td style="text-align:left;"><?php echo __('Date Of Birth'); ?><b style="color:red;">&nbsp; * </b></td>
        <td style="text-align:left;width:50px">:</td>
    ...
    <tr>
        <td style="text-align:left;"><?php echo __('Address Line1'); ?><b style="color:red;">&nbsp; * </b></td>
        <td style="text-align:left;width:50px">:</td>
    ...
    <tr>
        <td style="text-align:left;"><?php echo __('City'); ?><b style="color:red;">&nbsp; * </b></td>
        <td style="text-align:left;width:50px">:</td>
        <td style="text-align:left;"><?php echo $this->Form->input('city', array('label'=>''));?>&nbsp;</td>
    </tr>
    <tr>
        <td style="text-align:left;"><?php echo __('District'); ?><b style="color:red;">&nbsp; * </b></td>
        <td style="text-align:left;width:50px">:</td>
        <td style="text-align:left;">
    ...
    <tr>
        <td style="text-align:left;"><?php echo __('Province'); ?><b style="color:red;">&nbsp; * </b></td>
        <td style="text-align:left;width:50px">:</td>
        <td style="text-align:left;">
    ...
    <tr>
        <td style="text-align:left;"><?php echo __('Country'); ?><b style="color:red;">&nbsp; * </b></td>
        <td style="text-align:left;width:50px">:</td>
    ...
    <tr>
        <td style="text-align:left;"><?php echo __('Contact [Mobile]'); ?><b style="color:red;">&nbsp; * </b>&nbsp;</td>
        <td style="text-align:left;width:50px">:</td>
    ...
    <tr>
        <td colspan="3" style="text-align:right;padding-right:150px;"><?php echo $this->Form->submit('Submit', array('class' => 'but-color'));?>&nbsp;</td>
    </tr>   
    <tr>
        <td colspan="2" style="text-align:left;"><b style="color:red;">&nbsp; * Required fields </b></td>
        <td style="text-align:right;padding-right:0px;"><?php echo $this->Html->link('Skip this step', '/users/home');?></td>
    </tr>
</table>

    <?php echo $this->Form->end();?>
    <div>
    <?php //echo $this->Html->link('Forgot your password?', '/forgotten_password/');?>
